...
CREATE TABLE food (
  ...
  type                     smallint(6)                        NOT NULL DEFAULT 1 COMMENT '类型：1-原始类型 2-组合类型',
  ...
  serving_amount_unit_id   bigint(20)                         NOT NULL COMMENT '份的量的单位ID',
...
CREATE TABLE food_brand (
  ...
  food_id                 bigint(20)                         NOT NULL COMMENT '食物ID', 
  brand_id                bigint(20)                         NOT NULL COMMENT '品牌ID', 
  package_weight          decimal(15, 5)                     DEFAULT NULL COMMENT '包装重量',
  package_weight_unit_id  bigint(20)                         DEFAULT NULL COMMENT '包装重量单位ID',
...
CREATE TABLE unit (
  ...
  channel_id   bigint(20)                         NOT NULL COMMENT '渠道ID', 
  code         varchar(255)                       NOT NULL COMMENT '编码', 
  type         int(10)                            NOT NULL COMMENT '类型：1-serving unit 2-measure unit 3-package weight unit',
  name         varchar(255)                       NOT NULL COMMENT '名字', 
  description  varchar(1000)                      DEFAULT NULL COMMENT '描述', 
  display_name varchar(255)                       NOT NULL COMMENT '展示名字', 
  abbreviation varchar(255)                       DEFAULT NULL COMMENT '缩写', 
